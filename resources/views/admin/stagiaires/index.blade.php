...
@section('content')
    <div class="d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('admin.stagiaires.create') }}" class="btn btn-primary">Nouveau stagiaire</a>
    </div>
    <hr />
    @if ($errors->any())
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="{{ route('admin.stagiaires.absences', $rs->id) }}" type="button"
                                    class="btn btn-primary">Liste d'absences</a>
                                <a href="{{ route('admin.stagiaires.show', $rs->id) }}" type="button"
                                    class="btn btn-secondary">Détail</a>
                                <a href="{{ route('admin.stagiaires.edit', $rs->id) }}" type="button"
                                    class="btn btn-warning">Modifier</a>
                                <a href="{{ route('admin.stagiaires.valider', $rs->id) }}" type="button"
                                    class="btn btn-success">Valider</a>
                                <form action="{{ route('admin.stagiaires.destroy', $rs->id) }}" method="POST"
